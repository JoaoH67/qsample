...
# %% auto 0
__all__ = ['binom', 'joint_binom', 'Wilson_var', 'Wald_var', 'subset_cards', 'cartesian_product', 'subset_probs']
...
def joint_binom(k, n, p):
    ...
    np.array
        Joint probability
    """
    return np.prod(binom.pmf(k, n, p), axis=-1) # In case p is list of list: vector, else scalar
